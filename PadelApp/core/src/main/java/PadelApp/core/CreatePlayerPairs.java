...
public class CreatePlayerPairs {
    ...
    /**
     * This method remakes the order of the players so that the player pairs will be different.
     * It removes the first player from the player list and adds it to the end of the list.

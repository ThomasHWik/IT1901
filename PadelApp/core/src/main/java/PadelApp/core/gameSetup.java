...
/**
 * The gameSetup class represents the setup of a Padel game. It contains the maximum number of players allowed in a single game, the maximum number of double courts, and the maximum number of player pairs allowed in a game. It also contains the number of single and double courts needed for a game, and a list of player pairs.
 * 
...
public class gameSetup {
    ...
    /**
     * Sets up the amount of courts needed after choosing how many double courts are required.
     * Throws an IllegalArgumentException if the number of players is less than 4 per double court, or if the number of double courts exceeds the maximum available, or if the number of player pairs exceeds the maximum allowed.
     * @param ammount the number of double courts required
     * @throws IllegalArgumentException if the number of players is less than 4 per double court, or if the number of double courts exceeds the maximum available, or if the number of player pairs exceeds the maximum allowed.
     */

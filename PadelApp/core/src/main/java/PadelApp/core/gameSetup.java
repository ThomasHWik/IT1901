...
public class GameSetup {
     ...
     * Throws an IllegalArgumentException if the number of players is less than 4 per double court,
     ...
     * @throws IllegalArgumentException if the number of players and courts do not add up
     */

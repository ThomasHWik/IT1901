 ...
 * The class provides methods to set and get the filename and the ArrayList of
 * Player objects.
 * It also provides methods to add and remove players from the scoreboard,
 * and to save the scoreboard to a JSON file.
 *
 * @param filename  the name of the file to be used for storing the scoreboard
 *                  data
...
public class Scoreboard {
  ...
  /**
   * Constructs a new Scoreboard object with an empty list of players and a
   * default filename.
   */
  public Scoreboard() {
  ...
  /**
   * Constructs a Scoreboard object with a given filename and a list of players'
   * scores.
   *
